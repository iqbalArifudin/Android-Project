...
public class HasilActivity extends AppCompatActivity {
    protected void onCreate(Bundle savedInstanceState) {
        ...
        teams.add(new Hasil("ttps://upload.wikimedia.org/wikipedia/id/1/12/Logo_Persib.png","https://upload.wikimedia.org/wikipedia/commons/thumb/2/2a/Logo-pss-vector.svg/1200px-Logo-pss-vector.svg.png","Persib Bandung","PSS","2","1","FT","Min, 15/3"));
